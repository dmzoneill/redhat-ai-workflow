"""Audio/PulseAudio management mixin for Google Meet browser controller."""
...
class AudioMixin:
    """Mixin providing PulseAudio sink management, routing, and mute/unmute for meeting audio."""
