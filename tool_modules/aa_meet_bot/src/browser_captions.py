"""Caption capture mixin for Google Meet browser controller."""
...
if TYPE_CHECKING:
    from .browser_controller import CaptionEntry

logger = logging.getLogger(__name__)


class CaptionMixin:
    """Mixin providing caption capture via DOM observation and polling."""
