...
class AudioConfig:
    ...
    # Virtual sink for capturing meeting audio
    virtual_sink_name: str = "meet_bot_sink"
    
    # Virtual source for injecting bot audio
...
class MeetBotConfig:
    ...
    # Google accounts
    host_account: GoogleAccount = field(default_factory=lambda: GoogleAccount(
    ...
    bot_account: GoogleAccount = field(default_factory=lambda: GoogleAccount(
        email="daoneill@redhat.com",
