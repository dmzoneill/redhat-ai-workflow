"""K8s Basic Tools - Essential k8s operations.

For advanced operations, see tools_extra.py.

Tools included (~14):
- kubectl_get_pods, kubectl_describe_pod, kubectl_logs, kubectl_delete_pod, kubectl_get_deployments, ...
"""
...
def register_tools(server: FastMCP) -> int:
    """Register basic k8s tools with the MCP server."""
