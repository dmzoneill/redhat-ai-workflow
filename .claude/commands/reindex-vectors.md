...
description: "Reindex all vector databases for semantic code search."
arguments:
  - name: force
---
# Reindex All Vectors
...
```json
{
  "name": "hourly_vector_reindex",
  "skill": "reindex_all_vectors",
  "cron": "0 * * * *",
  "persona": "workspace",
  "enabled": true
}
...
The `workspace` persona includes the necessary tools (`code_search`, `knowledge`, `project`) for vector indexing operations.
...
- [Vector Search Documentation](../../docs/tool-modules/aa_code_search.md)
- [Cron Scheduler](../../docs/architecture/workflow-modules.md#scheduler)
