...
add_tldr_slide(prs, "What is an AI Assistant?", "1-10", [
    "## The Foundation",
...
add_tldr_slide(prs, "Dynamic Personas vs Multi-Agent", "11-17", [
    "## The Problem",
...
add_tldr_slide(prs, "YAML-Defined Workflows", "18-23", [
    "## What Are Skills?",
...
add_tldr_slide(prs, "Self-Healing Tools & Memory", "24-33", [
...
add_tldr_slide(prs, "Persistent Context Across Sessions", "30-33", [
    "## Why Memory Matters",
...
add_tldr_slide(prs, "Slack Bot & IDE Extension", "52-56", [
    "## Slack Bot",
...
add_tldr_slide(prs, "Quick Start & Daily Workflow", "57-60", [
    "## Installation",
