...
The Release agent is focused on shipping software to production. It provides tools for Konflux builds, container registry operations, and app-interface configuration.
...
|--------|-------|-------------|
| [konflux](../mcp-servers/konflux.md) | 40 | Build pipelines |
| [quay](../mcp-servers/quay.md) | 8 | Container images |
| [appinterface](../mcp-servers/appinterface.md) | 6 | GitOps config |
| [git](../mcp-servers/git.md) | 15 | App-interface changes |
