...
The Developer persona is your primary tool configuration for day-to-day development work. It provides tools for Git operations, GitLab MRs, Jira issues, and Google Calendar integration.
