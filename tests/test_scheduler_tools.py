...
def test_get_schedules_config(mock_cm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
def test_update_schedules_config(mock_cm):
    from tool_modules.aa_workflow.src.scheduler_tools import _update_schedules_config
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
def test_register_returns_count(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_list_scheduler_disabled(mock_cm, mock_sm):
    from tool_modules.aa_workflow.src.scheduler_tools import register_scheduler_tools
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_list_no_jobs(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_list_with_cron_job(mock_cm, mock_sm):
    mock_sm.is_service_enabled.return_value = True
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_list_poll_job(mock_cm, mock_sm):
    mock_sm.is_service_enabled.return_value = True
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_list_default_retry_badge(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_empty_name(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_empty_skill(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_no_schedule(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_invalid_cron(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_invalid_json(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_duplicate_name(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_cron_success(mock_cm, mock_sm):
    mock_cm.get.return_value = {}
    captured, _ = _build_captured_tools()
    result = await captured["cron_add"](
        name="test_job",
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_poll_success(mock_cm, mock_sm):
    mock_cm.get.return_value = {}
    captured, _ = _build_captured_tools()
    result = await captured["cron_add"](
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_retry_disabled(mock_cm, mock_sm):
    mock_cm.get.return_value = {}
    captured, _ = _build_captured_tools()
    result = await captured["cron_add"](
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_add_default_retry(mock_cm, mock_sm):
    mock_cm.get.return_value = {}
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_remove_not_found(mock_cm, mock_sm):
    mock_cm.get.return_value = {"jobs": []}
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_remove_success(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_enable_not_found(mock_cm, mock_sm):
    mock_cm.get.return_value = {"jobs": []}
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_enable_enable(mock_cm, mock_sm):
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_enable_disable(mock_cm, mock_sm):
    mock_cm.get.return_value = {"jobs": [{"name": "j"}]}
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_run_now_no_scheduler_no_job(mock_cm, mock_sm):
    mock_cm.get.return_value = {"jobs": []}
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_run_now_no_scheduler_executes_skill(mock_cm, mock_sm):
    mock_cm.get.return_value = {
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_run_now_with_scheduler_success(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_run_now_with_scheduler_failure(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_status_no_scheduler(mock_cm, mock_sm):
    mock_sm.is_service_enabled.return_value = True
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_status_with_scheduler_and_executions(mock_cm, mock_sm):
    mock_sm.is_service_enabled.return_value = True
    mock_cm.get.return_value = {
        "timezone": "US/Pacific",
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_notifications_no_engine(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_notifications_empty(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_cron_notifications_with_data(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_scheduler_toggle_enable_no_scheduler(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_scheduler_toggle_enable_already_running(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_scheduler_toggle_enable_start(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_scheduler_toggle_disable_running(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
...
@patch("tool_modules.aa_workflow.src.scheduler_tools.state_manager")
@patch("tool_modules.aa_workflow.src.scheduler_tools.config_manager")
async def test_scheduler_toggle_disable_not_running(mock_cm, mock_sm):
    captured, _ = _build_captured_tools()
