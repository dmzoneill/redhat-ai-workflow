...
class TestListPersonasImpl:
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_no_personas_dir(self, mock_dir):
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_empty_personas_dir(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_skips_readme(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_lists_persona_with_heading_and_role(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_lists_persona_no_role_section(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_handles_read_error(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
    ...
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    def test_multiple_personas(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _list_personas_impl
...
class TestLoadPersonaImpl:
    ...
    @pytest.mark.asyncio
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    async def test_dynamic_load_success(self, mock_dir):
    ...
    @pytest.mark.asyncio
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    async def test_dynamic_load_failure(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _load_persona_impl
    ...
    @pytest.mark.asyncio
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    async def test_fallback_static_mode(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _load_persona_impl
        ...
        with patch(
            ...
            persona_file.read_text.return_value = "# DevOps\nYou are a devops engineer."
    ...
    @pytest.mark.asyncio
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    async def test_fallback_persona_not_found(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _load_persona_impl
    ...
    @pytest.mark.asyncio
    @patch("tool_modules.aa_workflow.src.persona_tools.PERSONAS_DIR")
    async def test_fallback_read_error(self, mock_dir):
        from tool_modules.aa_workflow.src.persona_tools import _load_persona_impl
